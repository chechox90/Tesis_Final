...
namespace DLL.NEGOCIO.Operaciones
{
    public class N_RegistroHorario: I_N_RegistroHorario
    {
        ...
        public List<DTO_RegistroVueltas> GetRegistroVueltasByAllIdTerminal(int idUsuario, DateTime desde, DateTime hasta,int idTerminal)
        {
            return I_Dao_RegistroHorario.GetRegistroVueltasByAllIdTerminal(idUsuario, desde, hasta, idTerminal);
        }
        ...
        public DateTime GetRegistroHorarioByIdUsarioFecha(int idUsuario, DateTime hoy)
        {
            return I_Dao_RegistroHorario.GetRegistroHorarioByIdUsarioFecha(idUsuario,hoy);
        }
